...
<title>BIB: Search Account Holder</title>
</head>
<body>
			...
			<div class="col-8">
				<form:form cssClass="form-horizontal" role="form" id="accForm">
					<div class="form-group row">
						<Label for="accountNoS" class="col-2 col-form-Label"> Account
						No:</Label>
						<div class="col-8">
							<input type="text" class="form-control"
								placeholder="Enter Account No" name="accountNo"
								id="accountNoS" />
						</div>
						<div class="col-2">
	...
	function searchViaAjax() {
		var accnt = {}
		accnt["accountNo"] = $("#accountNoS").val();
        alert(JSON.stringify(accnt));
		$.ajax({
			type : "POST",
